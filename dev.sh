...
do_start() {
    ...
    (
        ...
        # proxies /ws (websocket) and /auth (the OIDC session mint, a plain
        # HTTP POST) to the backend so the client uses one same-origin URL.
